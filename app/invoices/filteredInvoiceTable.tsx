...
export function DataTable<TData, TValue>(
    ...
    const MainCalendar = () => {
        const getDate = () => {
            return table.getColumn("created")?.getFilterValue() as DateRange ?? null
        }

        const setDate = (newDate: DateRange) => {
            table.getColumn("created")?.setFilterValue(newDate)
        }
    ...
    return (
        <div>
            <div className={"flex items-center gap-2 py-4 " + classNames?.filter}>
                <Input
