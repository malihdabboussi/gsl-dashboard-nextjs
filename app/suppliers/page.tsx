...
import { getAllSuppliers, createSupplier } from "../actions";
...
export default function SuppliersPage() {
  ...
  const getData = async () => {
    ...
    const dataAll: Entity[] = await getAllSuppliers();
    const dataTop: Entity[] = await getAllSuppliers();
    const dataFirst: Entity[] = await getAllSuppliers();
    const dataRepeat: Entity[] = await getAllSuppliers();
    setData({
      all: dataAll,
      top: dataTop,
      firstTime: dataFirst,
