...
export function SupplierInvoiceTable({ supplier }: { supplier: Entity }) {
    // START
    /*
    ...
    */
    ...
    return <div className="flex flex-col gap-4">
        ...
        {isEditing && <InvoiceEditor isOpen={isEditing} setIsOpen={setIsEditing} invoiceId={invoiceId} setInvoiceId={setInvoiceId} isSupplier={true} />}
