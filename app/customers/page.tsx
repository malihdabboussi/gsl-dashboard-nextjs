        ...
        <BasePage customHead={head} pageId={2}>
            <Tabs defaultValue="all" className="flex flex-col gap-4">
                ...
                <TabsContent value="all">
                    <DataTable data={getData("all")} columns={getColumns(false)} classNames={classNames} />
                </TabsContent>
                <TabsContent value="top">
                    <DataTable data={getData("top")} columns={getColumns(false)} classNames={classNames} />
                </TabsContent>
                <TabsContent value="first-time">
                    <DataTable data={getData("first-time")} columns={getColumns(false)} classNames={classNames} />
                </TabsContent>
                <TabsContent value="repeat">
                    <DataTable data={getData("repeat")} columns={getColumns(false)} classNames={classNames} />
                </TabsContent>
            </Tabs>
        </BasePage>
    )
